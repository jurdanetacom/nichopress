...
$updater = new EDD_Theme_Updater_Admin(
	...
	// Config settings
	$config = array(
		'remote_api_url' => 'https://facilius.net', // Site where EDD is hosted
		'item_name'      => 'Nichopress', // Name of theme
		'theme_slug'     => 'nichopress', // Theme slug
		'version'        => '1.7', // The current version of this theme
		'author'         => 'Facilius Themes', // The author of this theme
		'download_id'    => '48', // Optional, used for generating a license renewal link
	...
	// Strings
	$strings = array(
		'theme-license'             => __( 'Licencia de tema', 'edd-theme-updater' ),
		'enter-key'                 => __( 'Introduce tu licencia', 'edd-theme-updater' ),
		'license-key'               => __( 'Numero de licencia:', 'edd-theme-updater' ),
		...
		'%1$s/%2$-sites'            => __( 'Tienes %1$s / %2$s sitios activos.', 'edd-theme-updater' ),
